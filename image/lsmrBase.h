...
public:
	...
	double Dnrm2(unsigned int n, const double* x, unsigned int start, unsigned int end, double* tmp_buffer, unsigned int t, unsigned int threads) const;
	 ...
	 */
	void Solve(unsigned int m, unsigned int n, const double * b, double * x, bool clear_x = true);
	void SolveParallel(unsigned int m, unsigned int n, const double* b, double* x, bool clear_x = true);
